...
public class Test {
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		stemmer.performStemming("bugSummary.txt", "afterStemmingBugSummary.txt");
		stemmer.performStemming("nonBugSummary.txt", "afterStemmingNonBugSummary.txt");
		...
		Training training = new Training(bugList, nonBugList);
